<div class="row" id="benefits">
    <div class="col-12 col-md-4 mt-4 mt-md-0">
        <h3>
            <em class="fa-regular fa-gem text-rector-green"></em>
            &nbsp;
    ...
    <div class="col-12 col-md-4 mt-4 mt-md-0">
        <h3>
            <em class="fas fa-money-check-alt text-rector-green"></em>
            &nbsp;
            Reduce Feature Costs
        </h3>

        <img src="/assets/images/homepage/save-finances.jpg" class="rounded-4 mb-3 mt-2" style="max-width: 100%">
    ...
    <div class="col-12 col-md-4 mt-4 mt-md-0">
        ...
        <h3>
            <em class="fas fa-broom text-rector-green"></em>
            &nbsp;
            Remove Technical Debt
        </h3>

        <img src="/assets/images/homepage/reconstruction.jpg" class="rounded-4 mb-3 mt-2" style="max-width: 100%">
        <p>
