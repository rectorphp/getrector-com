...
@section('main')
    <div id="about">
        ...
        <div class="text-medium">
            ...
            <p>
                You can learn about it from the <a href="{{ route('documentation') }}">documentation</a> or
        ...
        <div class="text-medium mt-5">
            ...
            <p>
                You can <a href="{{ route('hire_team') }}">hire our team</a> to get this expertise integrated into your team instantly.
            </p>
        </div>
