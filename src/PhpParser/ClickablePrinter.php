...
final class ClickablePrinter extends Standard
{
    ...
    protected function pExpr_Assign(Assign $assign): string
    {
        ...
        return $this->pInfixOp(Assign::class, $assign->var, $link, $assign->expr);
    }
    ...
    protected function pExpr_BinaryOp_LogicalXor(LogicalXor $logicalXor): string
    {
        ...
        $link = PrinterHelper::printLink(
            ' ' . $logicalXor->getOperatorSigil() . '  ',
            $this->uuid,
            $nodeId,
            $this->activeNodeId
        );

        return $this->pInfixOp(LogicalXor::class, $logicalXor->left, $link, $logicalXor->right);
    }
    ...
    protected function pExpr_BinaryOp_Equal(Equal $equal): string
    {
        ...
        $link = PrinterHelper::printLink(
            ' ' . $equal->getOperatorSigil() . '  ',
            $this->uuid,
            $nodeId,
            $this->activeNodeId
        );

        return $this->pInfixOp(Equal::class, $equal->left, $link, $equal->right);
    }
    ...
    protected function pExpr_BinaryOp_NotEqual(NotEqual $notEqual): string
    {
        ...
        $link = PrinterHelper::printLink(
            ' ' . $notEqual->getOperatorSigil() . '  ',
            $this->uuid,
            $nodeId,
            $this->activeNodeId
        );

        return $this->pInfixOp(NotEqual::class, $notEqual->left, $link, $notEqual->right);
    }
    ...
    protected function pExpr_BinaryOp_Identical(Identical $identical): string
    {
        ...
        $link = PrinterHelper::printLink(
            ' ' . $identical->getOperatorSigil() . '  ',
            $this->uuid,
            $nodeId,
            $this->activeNodeId
        );

        return $this->pInfixOp(Identical::class, $identical->left, $link, $identical->right);
    }
    ...
    protected function pExpr_BinaryOp_NotIdentical(NotIdentical $notIdentical): string
    {
        ...
        $link = PrinterHelper::printLink(
            ' ' . $notIdentical->getOperatorSigil() . '  ',
            $this->uuid,
            $nodeId,
            $this->activeNodeId
        );

        return $this->pInfixOp(NotIdentical::class, $notIdentical->left, $link, $notIdentical->right);
    }
    ...
    protected function pExpr_BinaryOp_Spaceship(Spaceship $spaceship): string
    {
        ...
        $link = PrinterHelper::printLink(
            ' ' . $spaceship->getOperatorSigil() . '  ',
            $this->uuid,
            $nodeId,
            $this->activeNodeId
        );

        return $this->pInfixOp(Spaceship::class, $spaceship->left, $link, $spaceship->right);
    }
    ...
    protected function pExpr_BinaryOp_Greater(Greater $greater): string
    {
        ...
        $link = PrinterHelper::printLink(
            ' ' . $greater->getOperatorSigil() . '  ',
            $this->uuid,
            $nodeId,
            $this->activeNodeId
        );

        return $this->pInfixOp(Greater::class, $greater->left, $link, $greater->right);
    }
    ...
    protected function pExpr_BinaryOp_GreaterOrEqual(GreaterOrEqual $greaterOrEqual): string
    {
        ...
        $link = PrinterHelper::printLink(
            ' ' . $greaterOrEqual->getOperatorSigil() . '  ',
            $this->uuid,
            $nodeId,
            $this->activeNodeId
        );

        return $this->pInfixOp(GreaterOrEqual::class, $greaterOrEqual->left, $link, $greaterOrEqual->right);
    }
    ...
    protected function pExpr_BinaryOp_Smaller(Smaller $smaller): string
    {
        ...
        $link = PrinterHelper::printLink(
            ' ' . $smaller->getOperatorSigil() . '  ',
            $this->uuid,
            $nodeId,
            $this->activeNodeId
        );

        return $this->pInfixOp(Smaller::class, $smaller->left, $link, $smaller->right);
    }
    ...
    protected function pExpr_BinaryOp_SmallerOrEqual(SmallerOrEqual $smallerOrEqual): string
    {
        ...
        $link = PrinterHelper::printLink(
            ' ' . $smallerOrEqual->getOperatorSigil() . '  ',
            $this->uuid,
            $nodeId,
            $this->activeNodeId
        );
    ...
    protected function pExpr_PropertyFetch(PropertyFetch $propertyFetch): string
    {
        ...
        return $this->pDereferenceLhs($propertyFetch->var) . $link . $this->pObjectProperty($propertyFetch->name);
    }
