...
<<<<<<< HEAD
=======
<<<<<<<< HEAD:src/Http/Controllers/Demo/ProcessDemoFormController.php
>>>>>>> b18d765 (lock carbon to keep compatbility with laravel)
<<<<<<<< HEAD:src/Http/Controller/Demo/ProcessDemoFormController.php
namespace Rector\Website\Http\Controller\Demo;
========
namespace Rector\Website\Http\Controllers\Demo;
>>>>>>>> 3b46dec (be toelrant about uiud):src/Http/Controllers/Demo/ProcessDemoFormController.php
<<<<<<< HEAD
=======
========
namespace Rector\Website\Http\Controller\Demo;
>>>>>>>> b18d765 (lock carbon to keep compatbility with laravel):src/Http/Controller/Demo/ProcessDemoFormController.php
>>>>>>> b18d765 (lock carbon to keep compatbility with laravel)
